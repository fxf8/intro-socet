...
VL_ATTR_COLD void Vfsm___024root__trace_full_0_sub_0(Vfsm___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+10,((0U == (IData)(vlSelfRef.tb_fsm__DOT__DUT__DOT__state))));
    bufp->fullCData(oldp+11,(vlSelfRef.tb_fsm__DOT__DUT__DOT__state),3);
    bufp->fullCData(oldp+12,(vlSelfRef.tb_fsm__DOT__DUT__DOT__next),3);
}
