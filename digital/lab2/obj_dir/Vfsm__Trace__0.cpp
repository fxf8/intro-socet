...
void Vfsm___024root__trace_chg_0_sub_0(Vfsm___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+9,((0U == (IData)(vlSelfRef.tb_fsm__DOT__DUT__DOT__state))));
    bufp->chgCData(oldp+10,(vlSelfRef.tb_fsm__DOT__DUT__DOT__state),3);
    bufp->chgCData(oldp+11,(vlSelfRef.tb_fsm__DOT__DUT__DOT__next),3);
}
