...
VL_ATTR_COLD void Vfsm___024root___eval_static(Vfsm___024root* vlSelf) {
    ...
    vlSelfRef.__Vtrigprevexpr___TOP__tb_fsm__DOT__CLK__0 = 0U;
...
VL_ATTR_COLD void Vfsm___024root___dump_triggers__act(Vfsm___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VactTriggered.word(0U))) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(negedge tb_fsm.nRST)\n");
    }
...
VL_ATTR_COLD void Vfsm___024root___dump_triggers__nba(Vfsm___024root* vlSelf) {
    ...
    if ((2ULL & vlSelfRef.__VnbaTriggered.word(0U))) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(negedge tb_fsm.nRST)\n");
    }
...
VL_ATTR_COLD void Vfsm___024root___ctor_var_reset(Vfsm___024root* vlSelf) {
    ...
    vlSelf->tb_fsm__DOT__DUT__DOT__state = VL_RAND_RESET_I(3);
    vlSelf->tb_fsm__DOT__DUT__DOT__next = VL_RAND_RESET_I(3);
