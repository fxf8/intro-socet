...
struct Vfsm_tb_fsm__DOT__TestVector__struct__0 {
    ...
    bool operator<(const Vfsm_tb_fsm__DOT__TestVector__struct__0& rhs) const {
        return std::tie(__PVT__test_number, __PVT__data_stream, __PVT__expected_output)
            <  std::tie(rhs.__PVT__test_number, rhs.__PVT__data_stream, rhs.__PVT__expected_output);
    }
};
template <>
struct VlIsCustomStruct<Vfsm_tb_fsm__DOT__TestVector__struct__0> : public std::true_type {};
...
class alignas(VL_CACHE_LINE_BYTES) Vfsm___024root final : public VerilatedModule {
  public:
    ...
    CData/*2:0*/ tb_fsm__DOT__DUT__DOT__state;
    CData/*2:0*/ tb_fsm__DOT__DUT__DOT__next;
    ...
    VlTriggerScheduler __VtrigSched_h32456086__0;
