...
void Vfull_adder::eval_end_step() {
    VL_DEBUG_IF(VL_DBG_MSGF("+eval_end_step Vfull_adder::eval_end_step\n"); );
#ifdef VM_TRACE
    // Tracing
...
//============================================================
// Events and timing
bool Vfull_adder::eventsPending() { return !vlSymsp->TOP.__VdlySched.empty(); }

uint64_t Vfull_adder::nextTimeSlot() { return vlSymsp->TOP.__VdlySched.nextTimeSlot(); }
...
void Vfull_adder___024root__trace_decl_types(VerilatedFst* tracep);

void Vfull_adder___024root__trace_init_top(Vfull_adder___024root* vlSelf, VerilatedFst* tracep);
...
VL_ATTR_COLD void Vfull_adder::traceBaseModel(VerilatedTraceBaseC* tfp, int levels, int options) {
    ...
    if (VL_UNLIKELY(!stfp)) {
        vl_fatal(__FILE__, __LINE__, __FILE__,"'Vfull_adder::trace()' called on non-VerilatedFstC object;"
