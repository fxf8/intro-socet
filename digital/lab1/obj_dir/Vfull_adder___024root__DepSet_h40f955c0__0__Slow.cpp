...
#endif
            VL_FATAL_MT("tb/tb_full_adder.sv", 2, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vfull_adder___024root___ctor_var_reset(Vfull_adder___024root* vlSelf) {
    ...
    auto& vlSelfRef = std::ref(*vlSelf).get();
    // Body
    vlSelf->tb_full_adder__DOT__tb_a = VL_RAND_RESET_I(1);
    vlSelf->tb_full_adder__DOT__tb_b = VL_RAND_RESET_I(1);
    vlSelf->tb_full_adder__DOT__tb_cin = VL_RAND_RESET_I(1);
    vlSelf->tb_full_adder__DOT__tb_s = VL_RAND_RESET_I(1);
    vlSelf->tb_full_adder__DOT__tb_cout = VL_RAND_RESET_I(1);
    vlSelf->tb_full_adder__DOT__test_number = 0;
    vlSelf->tb_full_adder__DOT__num_passed = 0;
