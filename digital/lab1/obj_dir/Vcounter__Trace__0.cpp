...
void Vcounter___024root__trace_chg_0_sub_0(Vcounter___024root* vlSelf, VerilatedFst::Buffer* bufp) {
    ...
    bufp->chgBit(oldp+1,(vlSelfRef.tb_counter__DOT__rst_n));
    bufp->chgCData(oldp+2,(vlSelfRef.tb_counter__DOT__count),3);
    bufp->chgIData(oldp+3,(vlSelfRef.tb_counter__DOT__num_tests),32);
    bufp->chgIData(oldp+4,(vlSelfRef.tb_counter__DOT__num_passed),32);
    bufp->chgIData(oldp+5,(vlSelfRef.tb_counter__DOT__unnamedblk1__DOT__i),32);
}
